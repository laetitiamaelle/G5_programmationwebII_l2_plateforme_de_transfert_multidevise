    ...
    return (
        <aside className='sidebar'>
            ...
            <nav className='nav'>
                ...
                <Link href="/app/transactions" className={`nav-item #{pathname === '/transactions' ? 'active' : ''}`}>
                ...
                <Link href="/app/exchange-rates/page.tsx" className={`nav-item #{pathname === '/exchanges-rates' ? 'active' : ''}`}>
